...
Spriteset_Base.prototype.sortMz = function() {
	if (this._hudField1) {
        this._hudField1.children.sort(function(a, b){return a.z-b.z});
	};	
	if (this._hudField2) {
        this._hudField2.children.sort(function(a, b){return a.z-b.z});
	};	
	if (this._hudField3) {
        this._hudField3.children.sort(function(a, b){return a.z-b.z});
	};
};
