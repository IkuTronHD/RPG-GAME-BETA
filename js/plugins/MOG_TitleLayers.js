...
Scene_Title.prototype.create = function() {
	...
	if (this._titleField1) {this._titleField1.children.sort(function(a, b){return a.z-b.z})};
	if (this._titleField3) {this._titleField3.children.sort(function(a, b){return a.z-b.z})}
};
